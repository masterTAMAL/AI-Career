...
export async function updateUser(data) {
  ...
  try {
    ...
    salaryRanges: [],
    growthRate: 0,
    demandLevel: DemandLevel.MEDIUM,       // ✅ enum
    topSkills: [],
    marketOutlook: MarketOutlook.NEUTRAL,  // ✅ enum
    keyTrends: [],
    recommendedSkills: [],
...
export async function getUserOnboardingStatus() {
  ...
  try {
    ...
    throw new Error("Failed to check onboarding status 505");
  }
}

// Ensure to run prisma generate after making schema changes
// npx prisma generate
